...
export function FeaturedProjects() {
    // Select top 3 projects for the dense 3-column grid
    const featuredSlugs = ["smart-agriculture", "fpga-32bit-alu", "lora-mesh-network"];
    const featuredWork = projects.filter(p => featuredSlugs.includes(p.slug));
    
    const displayProjects = featuredWork.length === 3 ? featuredWork : projects.slice(0, 3);
            ...
            <Container>
                <div className="flex flex-col mb-10 text-center">
                    ...
                    <p className="text-zinc-400 text-sm md:text-base max-w-xl mx-auto">
                        High-impact engineering projects with deeply integrated hardware-software architectures.
                    </p>
                </div>
